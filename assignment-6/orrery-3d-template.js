...
var lightDiffuse = vec4( red, blue, green, 1.0 );
var lightSpecular = vec4( red, blue, green, 1.0 );
...
function drawSphere(color, size) {
    ...
    var materialDiffuse = vec4( color[0], color[1], color[2], 1.0 );
    var materialSpecular = vec4( color[0], color[1], color[2], 1.0 );

    lightDiffuse = vec4( red, blue, green, 1.0 );
    lightSpecular = vec4( red, blue, green, 1.0 );
